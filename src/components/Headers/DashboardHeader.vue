		...
		<a-layout-header>
			<a-row :gutter="24">
				...
				<div style="justify-content:space-between">
					<router-link to="#" class="btn-sign-in" @click="e => e.preventDefault()">
					...
					<a-dropdown :trigger="['click']" class="btn-sign-in" overlayClassName="header-notifications-dropdown" :getPopupContainer="() => wrapper">
						...
						<a-list item-layout="horizontal" class="header-notifications-list" :data-source="notificationsData" slot="overlay">
							<a-list-item slot="renderItem" slot-scope="item">
								<a-list-item-meta>
									<a slot="title" href="/snapbyte">{{ item.title }}</a>
								</a-list-item-meta>
							</a-list-item>
						</a-list>
					</a-dropdown>
				...
				<div style="display: flex; align-items: center; justify-content:flex-start"><img class="brand" src="images/logo.png" alt=""> 
